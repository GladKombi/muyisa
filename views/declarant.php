...
include_once('../models/select/sel-declarant.php');
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main" class="main">
        <div class="row " >
            ...
            <div class="col-120 bg-dark position-fixed m-auto p-3">
                ...
                <h2 class=" text-success">declarant</h2>
              ...
              <div class="row">
                        ...
                        <div class="col-12 h-100  d-flex justify-content-center align-items-center p-4">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 bg-black card p-3 shadow   m-3">
                                <div class="card-header text-dark d-flex justify-content-between">
                                    ...
                                    <a href="declarant.php" class="btn btn-outline-danger text-white"><b><i class="bi bi-x"></i></b></a>
                                ...
                                <div class="card-footer">
                                    <a href='../models/del/del-declarant.php?id=<?=$_GET['idsup'] ?>' class="btn btn-outline-danger">Supprimer</a>
                                    <a href="declarant.php" class="btn btn-success">Annuler</a>
                                </div>
                                    ...
                                    <?php if(isset($_GET['numero'])){?>
                                      <div class="row">
                                          ...
                                          <div class="col-xl-4 col-lg-4 col-md-4  col-sm-4">
                                            <a href="declarant.php" class="btn btn-dark p-2  mt-1 w-100">Annuler</a>
                                        </div>
                                      </div>
                                    <?php }else {?>
                  ...
                  <?php }  ?>
                            ...
                            <div class="shadow p-3">
                                ...
                                <h4 class="p-3 ">Liste des declarants</h4>
                                    <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                            ...
                                            <td>
                                                <a href="declarant.php?numero=<?=$data['numero']?>" class="btn btn-success btn-sm "><i
